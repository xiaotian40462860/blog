...
<!--more-->
[![点击访问小莫的github](http://xiaomo.info/images/koajs.png)](https://github.com/qq83387856)
### 一、一键生成koa项目特性##
...
3. 运行项目  
4. 演示结束   
![koa生成器](http://xiaomo.info/images/koa-generator.gif)

查看大图 [koa生成器](http://xiaomo.info/images/koa-generator.gif)
