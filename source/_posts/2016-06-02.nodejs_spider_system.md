...
![](http://xiaomo.info/static/images/0.png)
...
![](http://xiaomo.info/static/images/1.png)
...
![](http://xiaomo.info/static/images/2.png)
...
![](http://xiaomo.info/static/images/3.png)


获取留言用户名和积分  

![](http://xiaomo.info/static/images/4.png)

在文章页面的源码找到评论的用户class名，classname为reply_author。console.log第一个元素 $('.reply_author').get(0)可以看到，我们需要获取东西都在这里头。

![](http://xiaomo.info/static/images/5.png)
